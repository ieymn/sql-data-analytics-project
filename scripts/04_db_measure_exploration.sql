...
SQL Functions Used:
    - COUNT(), SUM(), AVG(), WHERE, ORDER BY    
===============================================================================
*/

-- Find the Total Sales
SELECT SUM(total_amount) AS total_sales FROM gold.fact_sales
...
SELECT COUNT(DISTINCT customer_key) AS total_customers FROM gold.fact_sales WHERE order_status ='Completed';
